public class Ej45 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Introduce la posición donde quiere cambiar el número: ");
        int posicion = Integer.parseInt(System.console().readLine());
        System.out.print("Introduce el nuevo dígito: ");
        int digito = Integer.parseInt(System.console().readLine());
        System.out.printf("El número resultante es %s", ""+izqda(valor, posicion)+digito+dcha(valor, posicion+1));
    }
}
